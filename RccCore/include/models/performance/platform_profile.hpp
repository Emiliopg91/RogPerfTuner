...
private:
    static constexpr std::array<PlatformProfileMeta, 3> table{{{Enum::BALANCED, "BALANCED", 0},
                                                               {Enum::PERFORMANCE, "PERFORMANCE", 1},
                                                               {Enum::LOW_POWER, "LOW_POWER", 3}}};

    static constexpr const std::array<PlatformProfileMeta, 3> &metaTable() { return table; }
