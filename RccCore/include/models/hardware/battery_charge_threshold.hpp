...
private:
    static constexpr std::array<BatteryThresholdMeta, 3> table{{{Enum::CT_100, "CT_100", 100},
                                                                {Enum::CT_75, "CT_75", 75},
                                                                {Enum::CT_50, "CT_50", 50}}};

    static constexpr const std::array<BatteryThresholdMeta, 3> &metaTable() { return table; }
