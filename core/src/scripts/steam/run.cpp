...
#include "../../../include/models/steam_game_config.hpp"
                ...
                const std::string &parameters)
{
    ...
    argv[0] = const_cast<char *>(finalCommandStr.c_str());
    ...
    logger.add_tab();
    pid_t pid = Shell::getInstance().launch_process(argv[0], argv.data(), env.data());
...
int main(int argc, char *argv[])
{
    ...
    if (steamId)
    {
        auto res = cli.Get(Constants::URL_RENICE + "?appid=" + std::to_string(*steamId));
