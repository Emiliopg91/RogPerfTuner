...
class Cryptography:
    ...
    def encrypt_string(self, plaintext:str):
        ...
        cipher = Cipher(algorithms.AES(self.retrieve_key_from_keyring()), modes.GCM(nonce), backend=default_backend())
    ...
    def decrypt_string(self, encrypted_text):
        ...
        cipher = Cipher(algorithms.AES(self.retrieve_key_from_keyring()), modes.GCM(nonce, tag), backend=default_backend())
