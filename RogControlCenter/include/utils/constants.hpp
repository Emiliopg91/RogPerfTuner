...
class Constants {
  public:
	...
	inline const static std::string APP_VERSION = "4.1.2";

	inline const static pid_t PID = getpid();
	...
	inline static const std::string WRAPPER_PATH		= HOME_DIR + "/.RogControlCenter/bin" + "/steam/run";
