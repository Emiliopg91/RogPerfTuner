...
const CompatibleDeviceNameMap compatibleDeviceNameMap = {
	...
	{std::string(ASUS_ROG_GLADIUS_II_ORIGIN_COD.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_II_ORIGIN_COD.id_product),
	 std::string(ASUS_ROG_GLADIUS_II_ORIGIN_COD.name)},
	{std::string(ASUS_ROG_GLADIUS_II_ORIGIN_PNK_LTD.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_II_ORIGIN_PNK_LTD.id_product),
	...
	{std::string(ASUS_ROG_GLADIUS_II_WIRELESS_1.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_II_WIRELESS_1.id_product),
	...
	{std::string(ASUS_ROG_GLADIUS_III_WIRELESS_24GHZ.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_III_WIRELESS_24GHZ.id_product),
	 std::string(ASUS_ROG_GLADIUS_III_WIRELESS_24GHZ.name)},
	{std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_24GHZ.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_24GHZ.id_product),
	 std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_24GHZ.name)},
	{std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_USB.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_USB.id_product),
	 std::string(ASUS_ROG_GLADIUS_III_WIRELESS_AIMPOINT_USB.name)},
	{std::string(ASUS_ROG_GLADIUS_III_WIRELESS_BLUETOOTH.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_III_WIRELESS_BLUETOOTH.id_product),
	 std::string(ASUS_ROG_GLADIUS_III_WIRELESS_BLUETOOTH.name)},
	{std::string(ASUS_ROG_GLADIUS_III_WIRELESS_USB.id_vendor) + ":" + std::string(ASUS_ROG_GLADIUS_III_WIRELESS_USB.id_product),
	...
	{std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_24GHZ.id_vendor) + ":" + std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_24GHZ.id_product),
	 std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_24GHZ.name)},
	{std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_USB.id_vendor) + ":" + std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_USB.id_product),
	 std::string(ASUS_ROG_KERIS_WIRELESS_AIMPOINT_USB.name)},
	{std::string(ASUS_ROG_KERIS_WIRELESS_BLUETOOTH.id_vendor) + ":" + std::string(ASUS_ROG_KERIS_WIRELESS_BLUETOOTH.id_product),
	...
	{std::string(ASUS_ROG_STRIX_FLARE_COD_BLACK_OPS_4_EDITION.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_FLARE_COD_BLACK_OPS_4_EDITION.id_product),
	...
	{std::string(ASUS_ROG_STRIX_FLARE_II_ANIMATE.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_FLARE_II_ANIMATE.id_product),
	...
	{std::string(ASUS_ROG_STRIX_IMPACT_II_ELECTRO_PUNK.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_IMPACT_II_ELECTRO_PUNK.id_product),
	 std::string(ASUS_ROG_STRIX_IMPACT_II_ELECTRO_PUNK.name)},
	{std::string(ASUS_ROG_STRIX_IMPACT_II_GUNDAM.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_IMPACT_II_GUNDAM.id_product),
	 std::string(ASUS_ROG_STRIX_IMPACT_II_GUNDAM.name)},
	{std::string(ASUS_ROG_STRIX_IMPACT_II_MOONLIGHT_WHITE.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_IMPACT_II_MOONLIGHT_WHITE.id_product),
	 std::string(ASUS_ROG_STRIX_IMPACT_II_MOONLIGHT_WHITE.name)},
	{std::string(ASUS_ROG_STRIX_IMPACT_II_WIRELESS_24_GHZ.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_IMPACT_II_WIRELESS_24_GHZ.id_product),
	 std::string(ASUS_ROG_STRIX_IMPACT_II_WIRELESS_24_GHZ.name)},
	{std::string(ASUS_ROG_STRIX_IMPACT_II_WIRELESS_USB.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_IMPACT_II_WIRELESS_USB.id_product),
	...
	{std::string(ASUS_ROG_STRIX_SCOPE_II_96_RX_WIRELESS_USB.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_II_96_RX_WIRELESS_USB.id_product),
	 std::string(ASUS_ROG_STRIX_SCOPE_II_96_RX_WIRELESS_USB.name)},
	{std::string(ASUS_ROG_STRIX_SCOPE_II_96_WIRELESS_USB.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_II_96_WIRELESS_USB.id_product),
	...
	{std::string(ASUS_ROG_STRIX_SCOPE_NX_WIRELESS_DELUXE_USB.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_NX_WIRELESS_DELUXE_USB.id_product),
	...
	{std::string(ASUS_ROG_STRIX_SCOPE_RX_EVA02_EDITION.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_RX_EVA02_EDITION.id_product),
	 std::string(ASUS_ROG_STRIX_SCOPE_RX_EVA02_EDITION.name)},
	{std::string(ASUS_ROG_STRIX_SCOPE_RX_TKL_WIRELESS_DELUXE.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_RX_TKL_WIRELESS_DELUXE.id_product),
	...
	{std::string(ASUS_ROG_STRIX_SCOPE_TKL_PNK_LTD.id_vendor) + ":" + std::string(ASUS_ROG_STRIX_SCOPE_TKL_PNK_LTD.id_product),
