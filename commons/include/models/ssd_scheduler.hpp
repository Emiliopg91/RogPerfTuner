...
private:
    static constexpr std::array<SsdSchedulerMeta, 2> table{{{Enum::NOOP, "NOOP", "none"},
                                                            {Enum::MQ_DEADLINE, "MQ_DEADLINE", "mq-deadline"}}};

    friend Base;
    static constexpr const std::array<SsdSchedulerMeta, 2> &metaTable() { return table; }
};
